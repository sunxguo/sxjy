...
<body>
	...
	<div style="background:#fde2cf; height:40px;">
			<div style="width:1000px; margin:0 auto;">
			    <ul style="float:left;text-align:center;">
					...
					<li style="float:left; padding:11px 0; width:111px; background:#ff6600;">
						<a style="font-size:18px; color:#ffffff;">市县</a>
					</li>
					<li style="float:left; padding:11px 0; width:111px;">
	...
	<div>
		<div style="width:1000px; margin:0 auto;">
			...
			<ul style="padding:20px 0;">
				<li style="float:left;"><img src="images/85.png"/></li>
				<li style="float:right;"><img src="images/86.png"/></li>
				<div style="clear:both;"></div>
			</ul>
			<ul style="padding:10px 20px;">
				<li style="float:left; padding:5px 0;">【太原】原师院中区月底前搬迁　原址重新规划</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】原师院中区月底前搬迁　原址重新规划</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				...
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】业内人士：专业存废不能搞就业率“一票否决”</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】原师院中区月底前搬迁　原址重新规划</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				...
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】山西医科大学汾阳学院四项举措提升督察督办工作实效</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】“全日制书院”——中国父母另类教育选择</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】毕业生寒假求职：“中场”不休息 </li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】“市民学校”78岁老校长想退休却没人愿接班</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】太原等9个地市明年起中考实行网上评卷</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<li style="float:left; padding:5px 0;">【太原】山西医科大学汾阳学院四项举措提升督察督办工作实效</li>
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				...
				<li style="float:right; padding:5px 0;">2015年7月03日    16:37</li>
				<div style="clear:both;"></div>
				<div style="background:#eeeeee; height:42px;margin-top:50px; ">
					<ul style="padding:8px 220px;">
						<li style="width:40px; height:24px; background:#ff6600; border-radius:4px; float:left; text-align:center; line-height:24px; color:#ffffff;margin:0 10px;">《</li>
						<li style="float:left; text-align:center; line-height:24px;">
							<a style="margin:0 20px;">1</a>
							<a style="margin:0 20px; background:#ff6600; padding:5px 5px; border-radius:4px; color:#ffffff;">2</a>
							<a style="margin:0 20px;">3</a>
							<a style="margin:0 20px;">4</a>			
							<a style="margin:0 20px;">···</a>
							<a style="margin:0 20px;">1223</a>
						</li>
						<li style="width:40px; height:24px; background:#ff6600; border-radius:4px; float:right;text-align:center; line-height:24px; color:#ffffff;margin:0 10px;">》</li>
						<div style="clear:both;"></div>
					</ul>
				</div>
			</ul>	
	...
	<div style="background:#959595; margin-top:50px;">
