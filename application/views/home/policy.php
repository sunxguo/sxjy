			...
			<div style="border:1px solid #d4d4d4; height:1225px; margin-top:20px;">
				<div style="background:#eeeeee; width:960px; height:320px; margin:20px;">
					<ul>
						...
						<li style="float:left; padding:30px 30px;">
							<p style="font-size:18px; color:#0075a9;">晋中学院专家来我市开展“国培计划”</p>
							<p style="padding:10px 0; font-size:18px; color:#0075a9;">教师培训跟踪回访活动</p>
							<p style="padding:10px 0;">本网讯 1月8日，晋中学院“国培计划”培训</p>
							<p style="padding:10px 0;">部专家组一行来到我市，对我市“国培计划”</p>
							<p style="padding:10px 0;">培训学员开展跟踪回访活动。这次回访的主要</p>
							<p style="padding:10px 0;">内容是对2014年“国培计划”<span style="color:#0075a9">［详情］</span></p>
						</li>
						<div style="clear:both;"></div>
					</ul>
					<div style="height:34px; background:#eeeeee; margin-top:40px;"></div>
					<div style="height:38px; background:#6762a6; width:104px; margin-top:-38px; text-align:center; line-height:38px; font-size:18px; color:#ffffff;">最新动态</div>
					<div style="border-top:4px solid #6762a6; margin-top:-4px;"></div>
