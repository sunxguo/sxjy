...
<body style="text-align:center;">
		...
		<div style="background:url(images/2.1.png); height:112px;">
			<div style="width:1000px; margin:0 auto;padding-top:16px;">
				...
				<div style="float:right; margin-top:66px;">
				    <a>已注册账号？ 您可以直接</a>
					<a href="#" style="color:#008cc8;">登录</a>
				</div>
	...
	<div>
	    <div style="background:url(images/4.png); height:658px;">
				...
				<div style="height:38px; width:806px; padding:40px; margin-left:80px;">
					<div style="height:4px; width:806px; background:#d4d4d4;">
					    <div style="height:4px; width:274px; background:#ffffff;">
							<a style="background:none repeat scroll 0 0 #ffffff; border-radius: 78.5px 78.5px 78.5px 78.5px;padding:19px 19px;position: absolute; margin-top:2px;margin-top:-16px; margin-left:120px;"></a>
							<a style="background:none repeat scroll 0 0 #d4d4d4; border-radius: 78.5px 78.5px 78.5px 78.5px;padding:19px 19px;position: absolute; margin-top:2px;margin-top:-16px; margin-left:380px;"></a>
						</div>
						...
						<div style="height:460px; width:806px; background:#dff1f8;margin-top:24px;">
							<div style="padding-top:60px; width:450px; margin-left:138px;text-align:right;">
								<div>
									<a>*手机号码：</a>
									<input type="text" style="width:160px; height:28px; border:1px solid #d4d4d4; color:#646464;" placeholder="手机号/会员号/邮箱"/>
									<button style="height:30px; border:1px solid #d4d4d4; background:#dcdcdc; width:86px;">获取验证码</button>
							    </div>
								<div style="padding-top:25px;">
									<a>*短信验证码：</a>
									<input type="text" style="width:250px; height:28px; border:1px solid #d4d4d4; color:#646464;" />
							    </div>
								<div style="padding-top:25px;">
									<a>*登录密码：</a>
									<input type="text" style="width:250px; height:28px; border:1px solid #d4d4d4; color:#646464;" />
								...
								<div style="margin-top:25px;">
									<a>*验证码：</a>
									<input type="text" style="width:94px; height:28px; border:1px solid #d4d4d4; color:#646464;" />
									<button style="height:30px; border:1px solid #d4d4d4; background:#dcdcdc; width:58px;">s d r f</button>
									<a>点击图片更换</a>
							    </div>
								<div style="margin-top:25px; text-align:left; margin-left:198px;">
									<button style="width:114px; height:30px; background:#ffc000; border-radius:5px; border:none; color:#ffffff;">立即注册</button>
								</div>
								<div style="margin-top:15px; text-align:left; margin-left:200px;">
									<a href="regMail.html" style="color:#ffc000;">通过邮箱注册 》</a>
								</div>
							</div>
						</div>
					</div>
	...
	<div style="border-top:1px solid #d4d4d4; border-bottom:1px solid #d4d4d4; margin-top:20px;">
	...
	<p style="text-align:center; margin-top:10px;">主办单位：山西省教育宣传中心    晋ICP备11006001号—1</p>
</body>
</html>